...
**Last updated:** 2026-04-20 (post `/tool/pdf-to-office` worker fix — pdfjs `pdf.worker.mjs` now traced into standalone bundle + lazy file-URL workerSrc setter; real PDF round-trips locally to a valid .docx)
