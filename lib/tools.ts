...
export const TOOLS: readonly Tool[] = [
  ...
  { id: "ai-ats-resume", name: "ATS Resume Optimizer", desc: "audit your resume for ATS compatibility + get concrete fixes.", icon: "User", free: false, cost: "10 credits / resume", group: "AI" },
  { id: "ai-resume-parse", name: "Resume Parser", desc: "parse a resume into structured JSON (ATS / spreadsheet ready).", icon: "User", free: false, cost: "5 credits / resume", group: "AI" },
  ...
  { id: "ai-blood-test", name: "Blood Test Report Parser", desc: "lab values with normal/high/low flags. Extraction only, not medical advice.", icon: "File", free: false, cost: "15 credits / report", group: "AI" },
  { id: "ai-syllabus", name: "Syllabus to Study Plan", desc: "12-week study plan with topic map, practice checkpoints, revision strategy.", icon: "Book", free: false, cost: "20 credits / syllabus", group: "AI" },
  { id: "ai-discharge", name: "Discharge Summary Simplifier", desc: "plain-language rewrite for patients + families. Not medical advice.", icon: "Chat", free: false, cost: "10 credits / summary", group: "AI" },
  // Task #67 — Tier 3 §3.6, §3.3, §3.1 P0 wedges.
  { id: "ai-cover-letter", name: "Cover Letter Generator", desc: "tailored cover letter from your resume + optional JD. 300–350 words with customisation notes.", icon: "Edit", free: false, cost: "5 credits / letter", group: "AI" },
  { id: "ai-jd-match", name: "Resume ↔ JD Matcher", desc: "fit score + per-requirement alignment table + missing-keyword ATS audit. Paste the JD, drop the resume.", icon: "Compare", free: false, cost: "5 credits / resume", group: "AI" },
  // Task #69 — Tier 2 §2.3 P0: Scanned → Searchable PDF.
  { id: "ai-searchable-pdf", name: "Make PDF Searchable", desc: "OCR scanned pages and overlay invisible text so Ctrl-F finds matches. Visual layout unchanged.", icon: "Scan", free: false, cost: "2 credits / page", group: "AI" },
  // Task #75 — five Tier 3 P1 wedges.
  { id: "ai-nda", name: "NDA Analyzer", desc: "risk flags + negotiation points + missing standard clauses. Catches embedded non-competes, IP assignment.", icon: "Shield", free: false, cost: "15 credits / NDA", group: "AI" },
  { id: "ai-employment", name: "Employment Contract Review", desc: "comp + termination + risk flags (non-compete, IP, training bond) + negotiation points.", icon: "Shield", free: false, cost: "20 credits / contract", group: "AI" },
  // Task #77 — five more Tier 3 P1 wedges.
  { id: "ai-salary-slip", name: "Salary Slip Analyzer", desc: "structured JSON of earnings + deductions + YTD with original component names preserved for YoY comparison.", icon: "Receipt", free: false, cost: "10 credits / slip", group: "AI" },
  // Task #78 — five more Tier 3 wedges.
  { id: "ai-research-paper", name: "Research Paper Summarizer", desc: "citation + BibTeX + methods + results (magnitudes preserved) + limitations + how-to-cite examples + related reading.", icon: "Book", free: false, cost: "15 credits / paper", group: "AI" },
  { id: "ai-insurance", name: "Insurance Policy Analyzer", desc: "coverage + exclusions + waiting periods + claim process + renewal/portability + risk flags. Health/life/motor/home/travel/term.", icon: "Shield", free: false, cost: "20 credits / policy", group: "AI" },
  { id: "ai-loan-bundle", name: "Loan Application Bundler Audit", desc: "audits a stack of loan docs against lender checklist. Detects loan type, lists missing items, surfaces eligibility issues.", icon: "Receipt", free: false, cost: "15 credits / bundle", group: "AI" },
  // Task #79 — five more Tier 3 wedges.
  { id: "ai-partnership-deed", name: "Partnership Deed Analyzer", desc: "partners + capital + profit/loss share + decision-making + admission/retirement + risk flags. Partnership & LLP deeds.", icon: "Shield", free: false, cost: "20 credits / deed", group: "AI" },
  // Task #80 — five more Tier 3 wedges.
  // Task #81 — five more wedges (Tier 2 §2.5/§2.6/§2.8 + Tier 3 §3.3).
  { id: "ai-improve-writing", name: "Improve Writing", desc: "Rewrites for clarity + concision (~20-30% shorter) without changing facts, register, or claims.", icon: "Edit", free: false, cost: "5 credits / doc", group: "AI" },
  { id: "ai-paraphrase", name: "Paraphrase PDF", desc: "Rewords preserving every claim + number + conclusion. Same length as input. Technical terms preserved.", icon: "Edit", free: false, cost: "5 credits / doc", group: "AI" },
  ...
  { id: "ai-chart-to-table", name: "Chart → Data Table", desc: "Reads charts visually, extracts data points with axis labels + units. Bar / line / pie / scatter / stacked supported.", icon: "Pages", free: false, cost: "5 credits / chart", group: "AI" },
